...
public class EnjoyFix {
    ...
    private static final class V23 {
        ...
        private static void install(ClassLoader loader, List<File> files,
            ...
            Object[] objects = makePathElements(dexPathList,
                    new ArrayList<>(files), optimizedDirectory,
    ...
    private static class V19 {
        public static void install(ClassLoader loader, List<File> files, File dexOptDir) throws NoSuchFieldException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, IOException {
            //找到 pathList
            Field pathListField = ShareReflectUtil.findField(loader, "pathList");
            ...
            // 从 pathList找到 makeDexElements 方法并执行
            Object[] objects = makeDexElements(dexPathList,
                    new ArrayList<>(files), dexOptDir,
                    suppressedExceptions);
            ...
            if (suppressedExceptions.size() > 0) {
                for (IOException e : suppressedExceptions) {
                    Log.w(TAG, "Exception in makeDexElements", e);
                    throw e;
                }
